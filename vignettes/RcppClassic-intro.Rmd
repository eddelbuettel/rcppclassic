...
\bibitem[\protect\citeauthoryear{Eddelbuettel}{Eddelbuettel}{2013}]{Eddelbuettel:2013:Rcpp}
Eddelbuettel, D. (2013).
\newblock {\em Seamless R and C++ Integration with Rcpp}.
\newblock Use R! New York: Springer.

\bibitem[\protect\citeauthoryear{Eddelbuettel and Balamuta}{Eddelbuettel and
  Balamuta}{2017}]{PeerJ:Rcpp}
Eddelbuettel, D. and J.~J. Balamuta (2017, August).
\newblock Extending {R} with {C++}: A brief introduction to {Rcpp}.
\newblock {\em PeerJ Preprints\/}~{\em 5}.

\bibitem[\protect\citeauthoryear{Eddelbuettel, Fran\c{c}ois, Allaire, Ushey,
  Kou, Russel, Chambers, and Bates}{Eddelbuettel et~al.}{2017}]{CRAN:Rcpp}
Eddelbuettel, D., R.~Fran\c{c}ois, J.~Allaire, K.~Ushey, Q.~Kou, N.~Russel,
  J.~Chambers, and D.~Bates (2017).
\newblock {\em {Rcpp}: Seamless {R} and {C++} Integration}.
